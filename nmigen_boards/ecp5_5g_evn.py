...
class ECP55GEVNPlatform(LatticeECP5Platform):
    ...
    resources = [
        ...
        Resource("extclk", 0, Pins("B11", dir="i"), Attrs(IO_TYPE="LVCMOS33")),
        *LEDResources(
            pins="A13 A12 B19 A18 B18 C17 A17 B17",
            invert=True,
            attrs=Attrs(IO_TYPE=bank1_iostandard)
        ),
        *ButtonResources(pins="P4", invert=True, attrs=Attrs(IO_TYPE=bank6_iostandard)),
        *SwitchResources(
            pins={
                1: "J1",
                2: "H1",
                3: "K1"
            }, invert=True, attrs=Attrs(IO_TYPE=bank6_iostandard)
        ),
        *SwitchResources(
            pins={
                4: "E15",
        ...
        UARTResource(0, rx="P2", tx="P3", attrs=Attrs(IO_TYPE=bank6_iostandard, PULLMODE="UP")),
        *SPIFlashResources(
            0,
            cs="R2",
            clk="U3",
    ...
    connectors = [
        ...
        Connector(
            "J", 39,
            "- - - D15 B15 C15 B13 B20 D11 E11 B12 C12 D12 E12 C13 D13 E13 A14 A9 B10 - - - - - - - - E7 - A11 - A19 - - - - - - -"
        ),
        Connector(
            "J", 40,
            "K2 - A15 F1 H2 G1 J4 J5 J3 K3 L4 L5 M4 N5 N4 P5 N3 M3 - - K5 - M5 - L3 - N2 M1 L2 - L1 N1 C14 - P1 E14 D14 - K4 -"
        ),
        # Arduino
        ...
        Connector(
            "JP", 8,
            "- - T17 - U16 - U17 P18 - N20 N19 T16 M18 - N17 P17 - M17 U20 - T19 N18 R20 U19 - R18 L18 L17 U18 - T18 T20 P20 - R17 P19 N16 P16 - R16"
        ),
        # GPIO
        Connector("J", 5, "- - H20 G19 - - K18 J18 - - K19 J19 - - K20 J20 - - G20 - - -"
                 ),  # Contains 4 differential pairs
        ...
        Connector(
            "J", 33, "- - - - C2 B2 - - D1 C1 - - E1 D2 - - G5 H4 - - H3 H5 - - F3 G3 - - E2 F2 - -"

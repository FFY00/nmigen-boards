...
class MisterPlatform(IntelPlatform):
    ...
    default_clk = "clk50"
    resources = [
        Resource("clk50", 0, Pins("V11", dir="i"), Clock(50e6), Attrs(io_standard="3.3-V LVTTL")),
        Resource("clk50", 1, Pins("Y13", dir="i"), Clock(50e6), Attrs(io_standard="3.3-V LVTTL")),
        Resource("clk50", 2, Pins("E11", dir="i"), Clock(50e6), Attrs(io_standard="3.3-V LVTTL")),
        *LEDResources(
            pins="W15 AA24 V16 V15 AF26 AE26 Y16 AA23", attrs=Attrs(io_standard="3.3-V LVTTL")
        ),
        *ButtonResources(pins="AH17 AH16", invert=True, attrs=Attrs(io_standard="3.3-V LVTTL")),
        *SwitchResources(pins="Y24 W24 W21 W20", attrs=Attrs(io_standard="3.3-V LVTTL")),

        # Arduino header
        UARTResource(0, rx="AG13", tx="AF13", attrs=Attrs(io_standard="3.3-V LVTTL")),

        # LTC2308 analogue-to-digital converter
        SPIResource(
            0, cs="U9", clk="V10", mosi="AC4", miso="AD4", attrs=Attrs(io_standard="3.3-V LVTTL")
        ),
        ...
        Resource(
            ...
            Subsignal("tx_clk", Pins("AG5", dir="o")), Subsignal("tx_de", Pins("AD19", dir="o")),
            Subsignal("tx_hs", Pins("T8", dir="o")), Subsignal("tx_vs", Pins("V13", dir="o")),
            Subsignal("tx_int", Pins("AF11", dir="i")), Subsignal("i2s0", Pins("T13", dir="o")),
            Subsignal("mclk", Pins("U11", dir="o")), Subsignal("lrclk", Pins("T11", dir="o")),
            Subsignal("sclk", Pins("T12", dir="o")), Subsignal("scl", Pins("U10", dir="o")),
            Subsignal("sda", Pins("AA4", dir="io")), Attrs(io_standard="3.3-V LVTTL")
        ),
        ...
        SDRAMResource(
            ...
            cas="31",
            ba="34 35",
            a="37 38 39 40 28 25 26 23 24 21 36 22 19",
        ...
        Resource(
            "reset_switch", 0, PinsN("17", dir="i", conn=("gpio", 1)),
            Attrs(io_standard="3.3-V LVTTL")
        ),
        Resource(
            "osd_switch", 0, PinsN("13", dir="i", conn=("gpio", 1)),
            Attrs(io_standard="3.3-V LVTTL")
        ),
        Resource(
            "user_switch", 0, PinsN("15", dir="i", conn=("gpio", 1)),
            Attrs(io_standard="3.3-V LVTTL")
        ),
        Resource(
            "audio", 0, Subsignal("l", Pins("2", dir="o", conn=("gpio", 1))),
            Subsignal("r", Pins("7", dir="o", conn=("gpio", 1))), Attrs(io_standard="3.3-V LVTTL")
        ),
        ...
        *SDCardResources(
        ...
        Resource(
            "vga", 0, Subsignal("r", Pins("28 32 34 36 38 40", dir="o", conn=("gpio", 1))),
    ...
    connectors = [
        ...
        Connector(
            "gpio", 0, "V12  E8   W12  D11  D8   AH13 AF7  AH14 AF4  AH3  "
        ...
        Connector(
            "gpio", 1, "Y15  AC24 AA15 AD26 AG28 AF28 AE25 AF27 AG26 AH27 "
        ...
        Connector(
            "arduino", 0, "AG13 AF13 AG10 AG9  U14  U13  AG8  AH8  "
    ...
    def toolchain_program(self, products, name):
        ...
        with products.extract("{}.sof".format(name)) as bitstream_filename:
            ...
            subprocess.check_call([
                quartus_pgm, "--haltcc", "--mode", "JTAG", "--operation",
                "P;" + bitstream_filename + "@2"
            ])

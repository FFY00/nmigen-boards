...
class DE0CVPlatform(IntelPlatform):
    ...
    default_clk = "clk50"
    resources = [
        Resource("clk50", 0, Pins("M9", dir="i"), Clock(50e6), Attrs(io_standard="3.3-V LVTTL")),
        Resource("clk50", 1, Pins("H13", dir="i"), Clock(50e6), Attrs(io_standard="3.3-V LVTTL")),
        Resource("clk50", 2, Pins("E10", dir="i"), Clock(50e6), Attrs(io_standard="3.3-V LVTTL")),
        Resource("clk50", 3, Pins("V15", dir="i"), Clock(50e6), Attrs(io_standard="3.3-V LVTTL")),
        *LEDResources(
            pins="AA2 AA1 W2 Y3 N2 N1 U2 U1 L2 L1",
            invert=True,
            attrs=Attrs(io_standard="3.3-V LVTTL")
        ),
        *ButtonResources(pins="U7 W9 M7 M6", invert=True, attrs=Attrs(io_standard="3.3-V LVTTL")),
        *SwitchResources(
        ...
        Resource(
            "vga", 0, Subsignal("r", Pins("A9 B10 C9 A5", dir="o")),
            Subsignal("g", Pins("L7 K7 J7 J8", dir="o")),
            Subsignal("b", Pins("B6 B7 A8 A7", dir="o")), Subsignal("hs", Pins("H8", dir="o")),
            Subsignal("vs", Pins("G8", dir="o")), Attrs(io_standard="3.3-V LVTTL")
        ),
        Resource(
            "ps2_host",
            0,  # Keyboard
        ...
        *SDCardResources(
        ...
        SDRAMResource(
            ...
            cas="V6",
            ba="T7 AB7",
            a="W8 T8 U11 Y10 N6 AB10 P12 P7 P8 R5 U8 P6 R7",
            dq="Y9 T10 R9 Y11 R10 R11 R12 AA12 AA9 AB8 AA8 AA7 V10 V9 U10 T9",
            dqm="U12 N8",

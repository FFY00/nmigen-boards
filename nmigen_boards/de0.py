...
class DE0Platform(IntelPlatform):
    ...
    default_clk = "clk50"
    resources = [
        Resource("clk50", 0, Pins("G21", dir="i"), Clock(50e6), Attrs(io_standard="3.3-V LVTTL")),
        Resource("clk50", 1, Pins("B12", dir="i"), Clock(50e6), Attrs(io_standard="3.3-V LVTTL")),
        *LEDResources(pins="J1 J2 J3 H1 F2 E1 C1 C2 B2 B1", attrs=Attrs(io_standard="3.3-V LVTTL")),
        *ButtonResources(pins="H2 G3 F1", invert=True, attrs=Attrs(io_standard="3.3-V LVTTL")),
        *SwitchResources(
            pins="J6 H5 H6 G4 G5 J7 H7 E3 E4 D2", attrs=Attrs(io_standard="3.3-V LVTTL")
        ),
        Display7SegResource(
            0,
            a="E11",
        ...
        Resource(
            "vga", 0, Subsignal("r", Pins("H19 H17 H20 H21", dir="o")),
            Subsignal("g", Pins("H22 J17 K17 J21", dir="o")),
            Subsignal("b", Pins("K22 K21 J22 K18", dir="o")), Subsignal("hs", Pins("L21", dir="o")),
            Subsignal("vs", Pins("L22", dir="o")), Attrs(io_standard="3.3-V LVTTL")
        ),
        Resource(
            "ps2_host",
            0,  # Keyboard
        ...
        *SDCardResources(
        ...
        SDRAMResource(
            ...
            cas="G8",
            ba="B5 A4",
            a="C4 A3 B3 C3 A5 C6 B6 A6 C7 B7 B4 A7 C8",
            dq="D10 G10 H10 E9 F9 G9 H9 F8 A8 B9 A9 C10 B10 A10 E10 F10",
            dqm="E7 B8",
            attrs=Attrs(io_standard="3.3-V LVTTL")
        ),
        *NORFlashResources(
    ...
    connectors = [
        Connector(
            "j", 4, "AB12 AB16 AA12 AA16 AA15 AB15 AA14 AB14 AB13 AA13 -    -    "
            "AB10 AA10 AB8  AA8  AB5  AA5  AB3  AB4  AA3  AA4  V14  U14  "
            "Y13  W13  U13  V12  -    -    R10  V11  Y10  W10  T8   V8   "
            "W7   W6   V5   U7  "
        ),
        Connector(
            "j", 5, "AB11 AA20 AA11 AB20 AA19 AB19 AB18 AA18 AA17 AB17 -    -    "

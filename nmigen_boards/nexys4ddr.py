...
class Nexys4DDRPlatform(Xilinx7SeriesPlatform):
    ...
    resources = [
        ...
        *LEDResources(
        ...
        RGBLEDResource(0, r="N15", g="M16", b="R12", attrs=Attrs(IOSTANDARD="LVCMOS33")),
        RGBLEDResource(1, r="N16", g="R11", b="G14", attrs=Attrs(IOSTANDARD="LVCMOS33")),
        Display7SegResource(
            0,
            a="T10",
            b="R10",
        ...
        Resource(
            "display_7seg_an", 0, PinsN("J17 J18 T9 J14 P14 T14 K2 U13", dir="o"),
        ...
        Resource(
            "vga", 0, Subsignal("r", Pins("A3 B4 C5 A4", dir="o")),
            Subsignal("g", Pins("C6 A5 B6 A6", dir="o")),
            Subsignal("b", Pins("B7 C7 D7 D8", dir="o")), Subsignal("hs", Pins("B11", dir="o")),
            Subsignal("vs", Pins("B12", dir="o")), Attrs(IOSTANDARD="LVCMOS33")
        ),
        *SDCardResources(
            0,
            clk="B1",
        ...
        Resource(
            "audio", 0, Subsignal("pwm", Pins("A11", dir="o")),
            Subsignal("sd", PinsN("D12", dir="o")), Attrs(IOSTANDARD="LVCMOS33")
        ),
        UARTResource(
            0, rx="C4", tx="D4", rts="E5", cts="D3", attrs=Attrs(IOSTANDARD="LVCMOS33"), role="dce"
        ),
        Resource(
            "ps2_host", 0, Subsignal("clk", Pins("F4", dir="i")),
            Subsignal("dat", Pins("B2", dir="io")), Attrs(IOSTANDARD="LVCMOS33", PULLUP="TRUE")
        ),
        Resource(
            "eth",
            0,  # LAN8720A
        ...
        *SPIFlashResources(
        ...
        Resource(
            ...
            Subsignal(
                "dq", Pins("R7 V6 R8 U7 V7 R6 U6 R5 T5 U3 V5 U4 V4 T4 V1 T3", dir="io"),
            ...
            Subsignal(
                "dqs", DiffPairs("U9 U2", "V9 V2", dir="o"), Attrs(IOSTANDARD="DIFF_SSTL18_I")
            ),

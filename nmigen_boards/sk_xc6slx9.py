...
class SK_XC6SLX9Platform(XilinxSpartan6Platform):
    ...
    default_clk = "clk50"
    resources = [
        Resource("clk50", 0, Pins("P134", dir="i"), Clock(50e6), Attrs(IOSTANDARD="LVCMOS33")),
        *SPIFlashResources(
    ...
    connectors = [
        Connector(
            "x", 7, "-    -    P34  -    P33  P32  P30  P29  P27  P26  "

...
class AtlysPlatform(XilinxSpartan6Platform):
    ...
    resources = [
        ...
        Resource("clk100", 0, Pins("L15", dir="i"), Clock(100e6),
        ...
        *SPIFlashResources(
        ...
        Resource(
            ...
            Subsignal(
                "dqs", DiffPairs("P2 L4", "P1 L3", dir="o"), Attrs(IOSTANDARD="DIFF_SSTL18_II")
            ),
        ...
        Resource(
            "hdmi",
            0,  # J1, input only due to on board buffer, HDMI A connector
        ...
        Resource(
            "hdmi",
            1,  # J2, output only due to on board buffer, HDMI A connector
        ...
        Resource(
            "hdmi",
            2,  # J3, input only due to on board buffer, HDMI A connector
        ...
        Resource(
            "hdmi",
            3,  # JA, input/output as it is unbuffered, HDMI D connector
            Subsignal("scl", Pins("C13"), Attrs(IOSTANDARD="I2C")),
            Subsignal("sda", Pins("A13"), Attrs(IOSTANDARD="I2C")),
        ...
        Resource(
            "ac97", 0, Subsignal("clk", Pins("L13", dir="o")),
            Subsignal("sync", Pins("U17", dir="o")), Subsignal("reset", Pins("T17", dir="o")),
            Subsignal("sdo", Pins("N18", dir="o")), Subsignal("sdi", Pins("T18", dir="i")),
            Attrs(IOSTANDARD="LVCMOS33")
        ),
    ]
    connectors = [

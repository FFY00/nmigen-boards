...
class ICE40UP5KBEVNPlatform(LatticeICE40Platform):
    ...
    resources = [
        ...
        *LEDResources(pins="39 40 41", invert=True, attrs=Attrs(IO_STANDARD="SB_LVCMOS")),
        ...
        *SwitchResources(
            pins="23 25 34 43", invert=True, attrs=Attrs(IO_STANDARD="SB_LVCMOS", PULLUP=1)
        ),
        *SPIFlashResources(
            0, cs="16", clk="15", mosi="14", miso="17", attrs=Attrs(IO_STANDARD="SB_LVCMOS")
        ),
    ]
    connectors = [
        Connector(

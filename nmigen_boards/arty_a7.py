...
class ArtyA7Platform(Xilinx7SeriesPlatform):
    ...
    resources = [
        ...
        *SwitchResources(pins="A8  C11 C10 A10", attrs=Attrs(IOSTANDARD="LVCMOS33")),
        UARTResource(0, rx="A9", tx="D10", attrs=Attrs(IOSTANDARD="LVCMOS33")),
        Resource("cpu_reset", 0, Pins("C2", dir="o"), Attrs(IOSTANDARD="LVCMOS33")),
        SPIResource(0, cs="C1", clk="F1", mosi="H1", miso="G1", attrs=Attrs(IOSTANDARD="LVCMOS33")),
        Resource(
            "i2c", 0, Subsignal("scl", Pins("L18", dir="io")),
            Subsignal("sda", Pins("M18", dir="io")), Subsignal("scl_pullup", Pins("A14", dir="o")),
            Subsignal("sda_pullup", Pins("A13", dir="o")), Attrs(IOSTANDARD="LVCMOS33")
        ),
        *SPIFlashResources(
            0,
            cs="L13",
        ...
        Resource(
            ...
            Subsignal(
                "dqs", DiffPairs("N2 U2", "N1 V2", dir="io"), Attrs(IOSTANDARD="DIFF_SSTL135")
            ),
            Subsignal(
                "dq", Pins("K5 L3 K3 L6 M3 M1 L4 M2 V4 T5 U4 V5 V1 T3 U3 R3", dir="io"),
        ...
        Resource("eth_clk25", 0, Pins("G18", dir="o"), Clock(25e6), Attrs(IOSTANDARD="LVCMOS33")),
        Resource("eth_clk50", 0, Pins("G18", dir="o"), Clock(50e6), Attrs(IOSTANDARD="LVCMOS33")),
        Resource(
            "eth_mii",
            0,
